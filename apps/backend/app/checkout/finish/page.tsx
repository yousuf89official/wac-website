    ...
    return (
        <div className="min-h-screen flex items-center justify-center pt-24 pb-16 px-4">
            <div className="max-w-md text-center">
                ...
                <h1 className="text-2xl font-black text-white tracking-tighter mb-2">Payment Successful!</h1>
                <p className="text-gray-400 text-sm mb-8">Your enrollment has been confirmed. You can now access your course.</p>
