  ...
  return (
    <div className="card p-4">
      ...
      <div className="relative" onMouseLeave={() => setTooltipContent('')}>
                  ...
                  return (
                    <Geography
                      ...
                      style={{
                        ...
                        hover: { outline: 'none', opacity: 1, fill: '#14b8a6' },
        ...
        {tooltipContent && (
          <div
            className="fixed bg-slate-900 border border-lens-border rounded-lg px-3 py-2 shadow-xl text-xs text-lens-text pointer-events-none z-50"
