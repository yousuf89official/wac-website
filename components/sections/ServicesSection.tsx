...
const ServicesSection: React.FC = () => {
  ...
  return (
    <section id="services" className="relative py-[var(--section-padding)] bg-background">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-20">
          <motion.span
            ...
            viewport={{ once: true }}
            className="text-destructive text-sm font-semibold uppercase tracking-widest"
          >
            {sectionInfo?.badge || "Global Solutions"}
          </motion.span>
          <motion.h2
          ...
          >
            {sectionInfo?.headline || "Full-Spectrum Marketing Performance"}
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            {sectionInfo?.description || "Strategic expertise designed to scale your business and dominate your market."}
          </motion.p>
        </div>
